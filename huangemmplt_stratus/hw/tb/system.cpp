...
void system_t::config_proc()
{
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - huan_huangemmplt");
        ...
        ESP_REPORT_TIME(end_time, "END - huan_huangemmplt");
...
void system_t::load_memory()
{
...
#endif
    // TPH: change dim here
    change_dim(&rows, &loaded_cols, &cols);
    ...
    // for (int i = 0; i < huangemmplt_n; i++)
    //     for (int j = 0; j < huangemmplt_len * huangemmplt_vec; j++)
    //         in[i * in_words_adj + j] = j % huangemmplt_vec;
...
int system_t::validate()
{
    ...
    // for (int i = 0; i < huangemmplt_n; i++)
    //     for (int j = 0; j < huangemmplt_vec; j++)
